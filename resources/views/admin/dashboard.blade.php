    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white border border-gray-100 rounded-[1.5rem] p-6 shadow-sm">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                {{-- PERUBAHAN DISINI: Nama rute disesuaikan --}}
                <a href="{{ route('admin.berita.create') }}" class="flex flex-col items-center p-3 rounded-2xl bg-gray-50 hover:bg-blue-50 hover:text-blue-600 transition-all border border-transparent hover:border-blue-100">
                ...
                {{-- PERUBAHAN DISINI: Nama rute disesuaikan --}}
                <a href="{{ route('admin.kegiatan.create') }}" class="flex flex-col items-center p-3 rounded-2xl bg-gray-50 hover:bg-green-50 hover:text-green-600 transition-all border border-transparent hover:border-green-100">
